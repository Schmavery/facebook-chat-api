...
module.exports = function (defaultFuncs, api, ctx) {
  return function getUserDay(userID, callback) {
    ...
    var query =  'Query MontageThreadViewRoute {message_thread(' + userID + ') {@resultFragment}} ' +
                 ...
                 'QueryFragment dayFragment : UserMessage {message_id,message_sender {id},message_source_data {message_source},blob_attachments {__typename as type,@imageFragment,@videoFragment}} ' +
