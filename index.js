          ...
          return utils
            ...
            .then(function (res) {
              ...
              if (html.indexOf('checkpoint/?next') > -1) {
                const err = new Error('login-approval');
                err.error = 'login-approval';
                err.continue = function (code) {
                  ...
                  return utils
                    ...
                    .then(function (res) {
                      ...
                      if (!headers.location && res.body.indexOf('Review Recent Login') > -1) {
                        throw new Error('Something went wrong with login approvals.');
                      }
                ...
                if (!loginOptions.forceLogin) {
                  throw new Error('Couldn\'t login. Facebook might have blocked this account. Please login with a browser or enable the option \'forceLogin\' and try again.');
                }
                ...
                return utils
                  ...
                  .then(function (res) {
                    ...
                    if (!headers.location && res.body.indexOf('Review Recent Login') > -1) {
                      throw new Error('Something went wrong with review recent login.');
                    }
      ...
      return utils
        ...
        .then(function (res) {
          ...
          try {
            ...
            throw new Error('Error inside first pull request. Received HTML instead of JSON. Logging in inside a browser might help fix this.');
          }
