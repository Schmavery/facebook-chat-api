...
<!-- The form of the status request response has changed; it no longer sends five seperate keys - instead it sends a single value. The status states have been condensed to three numbers. -->
