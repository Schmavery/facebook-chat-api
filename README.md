...
First check that you can login to Facebook using the website or app. If login approvals are enabled, you might be logging in incorrectly. For how to handle 2-factor authorization, read our docs on [`login`](DOCS.md#login).
